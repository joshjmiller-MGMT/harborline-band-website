...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // List events: default = past 60 days through next 90 days. Past window
    // is wide enough that the month-grid view shows real history when the
    // user navigates back, instead of empty cells.
    const timeMin =
