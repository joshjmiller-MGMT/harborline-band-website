  ...
  input_schema: {
    ...
    properties: {
      ...
      logistics: {
        ...
        required: [
          "audio_reinforcement", "entrance", "green_room", "load_in",
          "meals", "parking", "setup_time", "soundcheck",
        ],
        additionalProperties: false,
      },
      organization: {
      ...
      preferences: {
        ...
        required: ["do_not_play", "line_dances", "must_play", "style_notes"],
        additionalProperties: false,
      },
      song_sections: {
        type: "array",
    ...
    required: [
      "attire", "client", "contact", "end_date", "event_date", "event_type",
